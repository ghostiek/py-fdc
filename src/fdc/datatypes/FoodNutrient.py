...
class FoodNutrient:
    def __init__(self, id: int = None, amount: float = None, data_points: int = None, min: float = None,
        ...
        self.food_nutrient_derivation = FoodNutritionDerivation(**food_nutrient_derivation) if food_nutrient_derivation else None
        self.nutrient_analysis_details = [NutrientAnalysisDetails(**i) for i in nutrient_analysis_details] if nutrient_analysis_details else None
